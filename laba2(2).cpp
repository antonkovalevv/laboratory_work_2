// laba2(2).cpp : Определяет точку входа для приложения.
//
...
class figure {
public:
    figure (bool type,int left, int top, int right, int bottom):m_type(type), m_left(left), m_top(top), m_right(right), m_bottom(bottom) {}
    void Draw(HDC hdc) {
        if (m_type == 1) {
